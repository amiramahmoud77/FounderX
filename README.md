...
Built with **Laravel 10**, it handles user authentication, pitch storage, AI integration, and secure API responses for the mobile app.
  ...
  <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
    ...
    <img src="FounderX-ScreenShots/2.png" alt="Screenshot 2" width="300" style="border-radius: 12px; box-shadow: 0 8px 32px rgba(0,0,0,0.3);">
    <img src="FounderX-ScreenShots/3.png" alt="Screenshot 3" width="300" style="border-radius: 12px; box-shadow: 0 8px 32px rgba(0,0,0,0.3);">
  </div>
